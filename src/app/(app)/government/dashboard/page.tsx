...
const HARDCODED_REQUESTS_V2 = [
    ...
    },
    {
        id: 'req_003',
        title: 'Flood',
        description: 'Flooding in low-lying areas. Immediate evacuation and medical assistance required.',
        type: 'flood',
        status: 'assigned',
        priority: 'high',
        location: 'null',
        coordinates: { lat: 40.7306, lng: -73.9352 },
        createdAt: new Date('2025-06-05T09:45:00'),
        assignedTo: 'John Doe',
        estimatedArrival: 'Within 30 minutes',
        helpTypes: ['medical', 'shelter']
    }
